...
export function Features() {
  ...
  return (
    <section id="features" className="scroll-mt-24 border-t border-line bg-paper px-6 py-24">
        ...
        <ul className="mt-14 grid gap-10 md:grid-cols-3">
          {features.items.map((item, index) => (
            <li key={item.title} className="relative">
              <span className="font-[family-name:var(--font-display)] text-sm font-bold tracking-[0.18em] text-accent">
